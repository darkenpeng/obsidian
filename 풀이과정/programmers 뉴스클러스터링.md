...
// 두 글자씩 끊어서 다중집합을 만들 수 있다. ㅇ

// {FR, RA, AN, NC, CE}, {FR, RE, EN, NC, CH} ㅇ

// 교집합은 {FR, NC}, 합집합은 {FR, RA, AN, NC, CE, RE, EN, CH} ㅇ

// 영문자로 된 글자 쌍만 유효하고, 기타 공백이나 숫자, ㅇ

// 특수 문자가 들어있는 경우는 그 글자 쌍을 버린다. ㅇ
...
function solution(str1, str2) {
	...
	const answer = J(parsed1, parsed2);
